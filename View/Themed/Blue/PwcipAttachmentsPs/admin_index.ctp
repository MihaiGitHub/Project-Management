...
echo $this->Html->link( $title, '/admin/attachments/add/'.$cipid, array('escape' => false));
?>
				</li>
            </ul>
        </div>
...
echo $this->Html->link('Attach Budget '.$budget, '/admin/projects/budget/'.$cipid, array('escape' => false)); ?></li>
<li><?php 
...
<li><?php echo $this->Html->link('Public Page', '/projects/project/'.$cipid, array('target' => 'new', 'escape' => false)); ?></li>
        ...
        <div class="grid_10">
            <div class="box round first fullpage">
                <h2><?php echo $this->Form->label(__('Attachments')); ?></h2>
                <div class="blockk">
                    <table class="display">
						<tbody>
						<?php $rows = 0;
						...
						<tr>
							<td style="width:15%;">
							<?php echo $this->Html->link(CakeTime::format('m/d/Y', $attachment['PwcipAttachmentsP']['Date']),
array('controller' => 'PwcipAttachmentsPs', 'action' => 'edit', $attachment['PwcipAttachmentsP']['AttachmentsID'])); ?>	
							</td>
							<td>
							<?php echo $this->Html->link($attachment['PwcipAttachmentsP']['AttachmentTitle'],
array('controller' => 'PwcipAttachmentsPs', 'action' => 'edit', $attachment['PwcipAttachmentsP']['AttachmentsID'])); ?>
							</td>
							<td><?php echo $attachment['PwcipAttachmentsP']['Comments']; ?></td>
						</tr>
