...
<li><?php echo $this->Html->link('Public Page', '/projects/project/'.$project['PwcipP']['CIPID'], array('target' => 'new', 'escape' => false)); ?></li>
		...
		<div class="message error">
			<h5>Error!</h5>
			<p>File type must be GIF, PNG, BMP, JPG or JPEG</p>
		</div>
		<?php } ?>
...
<?php echo $this->Form->create('PwcipP', array('enctype' => 'multipart/form-data', 'url' => 
											array('controller' => 'PwcipPs', 'action' => 'picture/'.$cipid))); ?>                    
					<table class="form">
                        <tr>
                            <td>
						...
						<tr>
							<td>
								<?php echo $this->Form->label(__('Current Project Picture')); ?>
							</td>
							<td>
<?php echo $this->Html->link($this->Html->image('/pictures/'.$project['PwcipP']['ProjectPicture'],
array('alt' => 'Picture', 'style' => 'height:75px;width:100px;')), '/pictures/'.$project['PwcipP']['ProjectPicture'], 
array('target' => 'new', 'escape' => false)); ?>
						...
						<tr>
                            <td>
                                <?php echo $this->Form->label('PictureFile', __('Attach Picture')); ?>
                            </td>
                            <td>
								<?php echo $this->Form->input('PictureFile', array('label' => false, 'type' => 'file')); ?>
                            </td>
                        </tr>	
						<?php if($action == 'EDIT'){ ?>
						<tr>
                            ...
                            <td>
								...
								</span> select "YES" to delete this picture
                            </td>
                        </tr>	
						<?php } ?>
					</table>
