...
<div class="right"><?php echo $this->Html->link('Projects Map', 'http://maps.tucsonaz.gov/construction/', array('escape' => false)); ?></div>
	<h2><?php echo $this->Form->label(__('Completed projects')); ?></h2>
		<table class="noborder">
			...
			<tr class="<?php echo $odd?'odd':'even'; ?>">
				<td colspan="3">
<?php echo $this->Html->link($drainage['Project']['CIPName'], 'project/'.$drainage['Project']['CIPID'], array('escape' => false)); ?>
				</td>
			</tr>
			<tr class="<?php echo $odd?'odd':'even'; ?>">
			...
			<tr class="<?php echo $odd?'odd':'even'; ?>">
				<td colspan="3"><a href="#">
<?php echo $this->Html->link($facility['Project']['CIPName'], 'project/'.$facility['Project']['CIPID'], array('escape' => false)); ?>
				</td>
			</tr>
			<tr class="<?php echo $odd?'odd':'even'; ?>">
				<td><strong>Status:</strong><?php echo $facility['Project']['Status']; ?></td><td>&nbsp;</td><td class="right"><?php if(isset($facility['Project']['UpdateDate'])){ ?><strong>Updated:</strong> <?php echo date('F n, o', strtotime($facility['Project']['UpdateDate'])); } ?></td>
			</tr>
			<tr class="<?php echo $odd?'odd':'even'; ?>">
			...
			<tr class="<?php echo $odd?'odd':'even'; ?>">
				<td colspan="3">
<?php echo $this->Html->link($misc['Project']['CIPName'], 'project/'.$misc['Project']['CIPID'], array('escape' => false)); ?>
				</td>
			</tr>
			<tr class="<?php echo $odd?'odd':'even'; ?>">
			...
			<tr class="<?php echo $odd?'odd':'even'; ?>">
				<td colspan="3">
<?php echo $this->Html->link($signal['Project']['CIPName'], 'project/'.$signal['Project']['CIPID'], array('escape' => false)); ?>
				</td>
			</tr>
			<tr class="<?php echo $odd?'odd':'even'; ?>">
			...
			<tr class="<?php echo $odd?'odd':'even'; ?>">
				<td colspan="3">
<?php echo $this->Html->link($trans['Project']['CIPName'], 'project/'.$trans['Project']['CIPID'], array('escape' => false)); ?>
				</td>
			</tr>
			<tr class="<?php echo $odd?'odd':'even'; ?>">
			...
			<tr class="<?php echo $odd?'odd':'even'; ?>">
				<td colspan="3">
<?php echo $this->Html->link($waste['Project']['CIPName'], 'project/'.$waste['Project']['CIPID'], array('escape' => false)); ?>
				</td>
			</tr>
			<tr class="<?php echo $odd?'odd':'even'; ?>">
			...
			<tr class="<?php echo $odd?'odd':'even'; ?>">
				<td colspan="3">
<?php echo $this->Html->link($water['Project']['CIPName'], 'project/'.$water['Project']['CIPID'], array('escape' => false)); ?>
				</td>
			</tr>
			<tr class="<?php echo $odd?'odd':'even'; ?>">
