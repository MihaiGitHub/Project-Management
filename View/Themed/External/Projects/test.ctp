<table align="center" class="nocolor" style="margin:0 auto">
		<tr>
...
<div class="right"><?php echo $this->Html->link('Projects Map', 'http://maps.tucsonaz.gov/construction/', array('escape' => false)); ?></div>
	<h2><?php echo $this->Form->label(__('Current Projects')); ?></h2>
		<table class="noborder">
			...
			<?php $odd = TRUE;
			// Drainage
			if($pdrainage) echo '<tr class="pname"><td><b>Drainage</b></td></tr>'; 
...
<?php echo $this->Html->link($drainage['Project']['CIPName'], '/projects/project/'.$drainage['Project']['CIPID'], array('escape' => false)); ?>
			...
			<tr class="<?php echo $odd?'odd':'even'; ?>">
				<td><strong>Status:</strong><?php echo $drainage['Project']['Status']; ?></td><td>&nbsp;</td><td><strong>Updated:</strong> <?php echo date('F n, o', strtotime($drainage['Project']['UpdateDate'])); ?></td>
			</tr>
			<tr class="<?php echo $odd?'odd':'even'; ?>">
...
<?php echo $this->Html->link($facility['Project']['CIPName'], '/projects/project/'.$facility['Project']['CIPID'], array('escape' => false)); ?>
			...
			<tr class="<?php echo $odd?'odd':'even'; ?>">
				<td><strong>Status:</strong><?php echo $facility['Project']['Status']; ?></td><td>&nbsp;</td><td><strong>Updated:</strong> <?php echo date('F n, o', strtotime($facility['Project']['UpdateDate'])); ?></td>
			</tr>
			<tr class="<?php echo $odd?'odd':'even'; ?>">
...
<?php echo $this->Html->link($misc['Project']['CIPName'], '/projects/project/'.$misc['Project']['CIPID'], array('escape' => false)); ?>
			...
			<tr class="<?php echo $odd?'odd':'even'; ?>">
				<td><strong>Status:</strong><?php echo $misc['Project']['Status']; ?></td><td>&nbsp;</td><td><strong>Updated:</strong> <?php echo date('F n, o', strtotime($misc['Project']['UpdateDate'])); ?></td>
			</tr>
			<tr class="<?php echo $odd?'odd':'even'; ?>">
...
<?php echo $this->Html->link($signal['Project']['CIPName'], '/projects/project/'.$signal['Project']['CIPID'], array('escape' => false)); ?>
			...
			<tr class="<?php echo $odd?'odd':'even'; ?>">
				<td><strong>Status:</strong><?php echo $signal['Project']['Status']; ?></td><td>&nbsp;</td><td><strong>Updated:</strong> <?php echo date('F n, o', strtotime($signal['Project']['UpdateDate'])); ?></td>
			</tr>
			<tr class="<?php echo $odd?'odd':'even'; ?>">
...
<?php echo $this->Html->link($trans['Project']['CIPName'], '/projects/project/'.$trans['Project']['CIPID'], array('escape' => false)); ?>
			...
			<tr class="<?php echo $odd?'odd':'even'; ?>">
				<td><strong>Status:</strong><?php echo $trans['Project']['Status']; ?></td><td>&nbsp;</td><td><strong>Updated:</strong> <?php echo date('F n, o', strtotime($trans['Project']['UpdateDate'])); ?></td>
			</tr>
			<tr class="<?php echo $odd?'odd':'even'; ?>">
...
<?php echo $this->Html->link($waste['Project']['CIPName'], '/projects/project/'.$waste['Project']['CIPID'], array('escape' => false)); ?>
			...
			<tr class="<?php echo $odd?'odd':'even'; ?>">
				<td><strong>Status:</strong><?php echo $waste['Project']['Status']; ?></td><td>&nbsp;</td><td><strong>Updated:</strong> <?php echo date('F n, o', strtotime($waste['Project']['UpdateDate'])); ?></td>
			</tr>
			<tr class="<?php echo $odd?'odd':'even'; ?>">
...
<?php echo $this->Html->link($water['Project']['CIPName'], '/projects/project/'.$water['Project']['CIPID'], array('escape' => false)); ?>
			...
			<tr class="<?php echo $odd?'odd':'even'; ?>">
				<td><strong>Status:</strong><?php echo $water['Project']['Status']; ?></td><td>&nbsp;</td><td><strong>Updated:</strong> <?php echo date('F n, o', strtotime($water['Project']['UpdateDate'])); ?></td>
			</tr>
			<tr class="<?php echo $odd?'odd':'even'; ?>">
